...
Describe "Integration Tests" -Tag "IntegrationTests" {
    ...
    Context "Get-TenPlugin" {
        It "Returns proper plugin information" {
            ...
            $results | Select-Object -ExpandProperty Name | Should -Be 'Test Plugin for esxcustomizer'
            $results | Select-Object -ExpandProperty PluginId | Should -Be 100000
            ($results | Select-Object -ExpandProperty Attributes).fname | Should -Be 'esxcustomizer_test.nasl'
        }
    }
}